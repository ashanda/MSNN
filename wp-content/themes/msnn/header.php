...
<html <?php language_attributes(); ?>>
	<head>        
		...
		<link href="https://fonts.googleapis.com/css2?family=Bebas+Neue&family=Poppins:wght@500;600&family=Quicksand&display=swap" rel="stylesheet">
	...
	<body <?php body_class(); ?>>
		...
		<div id="main-wrapper">				
			<div id="header-wrapper">
				<div id="header-top">
					<p class="header-contact"><span class="fa fa-phone"></span><a href="#">07305 528610</a>  <label>|</label>  <a href="#">CONTACT</a></p>					
